...
/**
 * View class for a list of Jdbuildermanager.
 *
 * @since  1.6
 */
class JdbuildermanagerViewSections extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		JdbuildermanagerHelper::addSubmenu('sections');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_JDBUILDERMANAGER_TITLE_SECTIONS'), 'sections.png');
		...
		{
			JToolBarHelper::preferences('com_jdbuildermanager');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_jdbuildermanager&view=sections');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`title`' => JText::_('COM_JDBUILDERMANAGER_SECTIONS_TITLE'),
			'a.`categories`' => JText::_('COM_JDBUILDERMANAGER_SECTIONS_CATEGORIES'),
			'a.`thumbnail`' => JText::_('COM_JDBUILDERMANAGER_SECTIONS_THUMBNAIL'),
			'a.`minversion`' => JText::_('COM_JDBUILDERMANAGER_SECTIONS_MINVERSION'),
		);
	}
